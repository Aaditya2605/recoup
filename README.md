...
- `study_server.py` serves only the Terac study and its submission endpoint on port 8001. Use that restricted process for a temporary public study tunnel; never expose the full local case app.
